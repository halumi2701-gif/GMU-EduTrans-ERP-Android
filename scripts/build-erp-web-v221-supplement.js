...
function main() {
  ...
  assertIncludes(loader, 'v22.1-sales-portfolio-target-automatic', 'portfolio target release marker');
  ...
  assertIncludes(sales, 'v_sales_portfolio_monthly', 'automatic paid-pax view');
  ...
  if (fs.existsSync(manifestPath)) {
    ...
    manifest.additiveRelease = 'GMU EduTrans Portfolio Target & Package Policy v22.1';
  ...
  console.log(`GMU EduTrans v22.1 supplemental release copied: ${SUPPLEMENTAL_MODULES.join(', ')}`);
}
