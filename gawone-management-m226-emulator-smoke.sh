...
APK="GAWONE-Management-v1.0.9-M2.26-LABOUR-RECOVERY-debug.apk"
REPORT_DIR="management-m226-emulator-reports"
mkdir -p "$REPORT_DIR"
...
echo "GAWONE Management M2.26 Labour recovery emulator gate: PASS" | tee "$REPORT_DIR/RESULT.txt"
